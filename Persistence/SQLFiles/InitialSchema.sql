...
CREATE DATABASE [FileStorage]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'FileStorage', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.SQLEXPRESS\MSSQL\DATA\FileStorage.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'FileStorage_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.SQLEXPRESS\MSSQL\DATA\FileStorage_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [FileStorage] SET COMPATIBILITY_LEVEL = 130
GO
...
ALTER DATABASE [FileStorage] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [FileStorage] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [FileStorage] SET QUERY_STORE = OFF
GO
